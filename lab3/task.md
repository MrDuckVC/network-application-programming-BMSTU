...
- Создаем файл `.gitignore` и копируем туда содержимое [файла](../assets/lab3/.gitignore).
...
![Фото 10](../assets/lab3/photo10.png)
