...
![Express server is running](../assets/lab4/express-server-is-running.png)
...
![Sequence base](../assets/lab4/sequence-base.png)

Схема взаимодействия в данной ЛР:

![Sequence stock](../assets/lab4/sequence-stock.png)
...
![Get All](../assets/lab4/get-all-stocks.png)

### GET /stocks?title=Акция 1 — поиск по названию

![Get with query](../assets/lab4/get-all-stocks-with-query.png)

### POST /stocks — создание новой карточки

![Post](../assets/lab4/create-stock.png)

Проверяем, что карточка появилась:

![Get with created](../assets/lab4/get-stocks-with-created.png)

### GET /stocks/:id — получение карточки по ID

![Get by id](../assets/lab4/get-stock-by-id.png)

### PATCH /stocks/:id — обновление карточки

![Patch by id](../assets/lab4/patch-stock-by-id.png)

Проверяем результат:

![Get all after patch](../assets/lab4/get-stock-by-id-after-patch.png)

### DELETE /stocks/:id — удаление карточки

![Delete by id](../assets/lab4/delete-stock-by-id.png)

Проверяем удаление:

![Get after delete by id](../assets/lab4/get-all-stocks-after-delete-by-id.png)

### Итоговая структура проекта

![Final structure](../assets/lab4/final-project-structure.png)
